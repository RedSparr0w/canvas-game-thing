...
import { PokemonLevelType, PokemonType } from './PokemonEnums';
...
export const pokemonList = [
  ...
  },
  {
    ...
    levelType: PokemonLevelType.fast,
    exp: 113,
    eggCycles: 10,
    base: {
      hitpoints: 70,
  ...
  },
  {
    ...
    catchRate: 190,
    type: [PokemonType.Fire],
    levelType: PokemonLevelType.slow,
    exp: 70,
    eggCycles: 20,
    base: {
      hitpoints: 55,
  ...
  },
  {
    ...
    type: [PokemonType.Grass],
    eggCycles: 15,
    levelType: PokemonLevelType.fluctuating,
    exp: 59,
    catchRate: 255,
    base: {
      hitpoints: 60,
  ...
  },
  {
    ...
    eggCycles: 15,
    levelType: PokemonLevelType.erratic,
    exp: 53,
    catchRate: 255,
    base: {
      hitpoints: 31,
...
pokemonList.forEach((p) => {
  ...
  let cost = +Math.floor((highestAtt + highestDef + p.base.hitpoints + p.base.speed) ** 2.7 / 20000).toPrecision(2);
  cost = Math.round(cost / 5) * 5;
  p.cost = p.cost || cost;
  pokemonNameIndex[p.name.toLowerCase()] = p;
});

export const pokemonMap = new Proxy(pokemonList, {
